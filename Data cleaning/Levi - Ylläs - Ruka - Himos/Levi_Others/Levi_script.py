...
df_Levi_cc = df_Levi_cc[['Date', 'cloud_cover_code']]

df_Levi_cc['Date'] = pd.to_datetime(df_Levi_cc['Date'])

final_df = pd.merge(combined_df, df_Levi_cc, on='Date')

final_df.to_csv('Levi - Ylläs - Ruka - Himos\Levi_Combined\levi_intermediate.csv', index=False)